<template>
  <div @keydown.esc="toggleModal" @click="checkClick" ref="invoiceWrap" class="invoice-wrap flex flex-column">
        ...
        <div class="work-items">
          ...
          <table class="item-list">
            ...
            <tr class="table-items flex" v-for="(item, index) in invoiceItemList" :key="index">
              ...
              <img @click="deleteInvoiceItem(index)" src="@/assets/icon-delete.svg" alt="" />
            </tr>
          </table>
